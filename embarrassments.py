...
async def main(no_strip = False, priv_key = None, addr = '1PTtzfR9ZpLzFsbp6bKVmQtWa5zsd9KotD', coin = 'BitcoinSV', net = 'mainnet', regexp=None):
    ...
    for items in await blockchain.addr_history(addr):
        txid = items['tx_hash']
        height = items['height']
